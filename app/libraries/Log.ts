...
if (config.log.logToFiles) {
  const logDir = path.join(process.env.HOME, ".example-flugzeug-app-logs");
  ...
  log.add(winston.transports.File, {
    name: "error-file",
    level: "error",
    filename: path.join(logDir, "example-flugzeug-app-error.log"),
    json: true,
  });
  ...
  log.add(winston.transports.File, {
    name: "warn-file",
    level: "warn",
    filename: path.join(logDir, "example-flugzeug-app-warn.log"),
    json: true,
  });
  ...
  log.add(winston.transports.File, {
    name: "debug-file",
    level: "debug",
    filename: path.join(logDir, "example-flugzeug-app-debug.log"),
    json: true,
  });
  ...
  requestLog.add(winston.transports.File, {
    name: "request-file",
    level: "info",
    filename: path.join(logDir, "example-flugzeug-app-requests.log"),
    json: true,
  });
}
